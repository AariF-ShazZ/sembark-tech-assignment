...
export async function fetchProducts(
  ...
  if (params.title !== undefined)  searchParams["title"] = params.title;
  if (params.price_min !== undefined) searchParams["price_min"] = params.price_min;
  if (params.price_max !== undefined)  searchParams["price_max"] = params.price_max;
